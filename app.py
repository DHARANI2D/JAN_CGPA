...
def main():
    ...
    default_subjects = [
        ("DEVOPS", 3, 'O'),
        ("INTERNET OF EVERYTHING", 3, 'O'),
        ("INTERNET OF EVERYTHING LABORATORY", 1.5, 'O'),
        ("HUMAN COMPUTER INTERACTION", 3, 'O'),
        ("BUSINESS ANALYTICS", 3, 'O'),
        ("EMPLOYABILITY ENHANCEMENT SKILLS", 2, 'O'),
        ("COMPUTATIONAL BIOLOGY", 3, 'O'),
        ("INDUSTRIAL SAFETY / TOTAL QUALITY MANAGEMENT", 3, 'O')
    ]
    ...
    if st.sidebar.button("Calculate CGPA"):
        ...
        st.success(f"Your VII SEM GPA is: {cgpa:.2f}")
